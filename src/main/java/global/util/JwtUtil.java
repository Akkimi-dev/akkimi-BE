...
public class JwtUtil {
    ...
    */
    ...
    public String getSocialIdFromRefresh(String token) {
        return getSocialIdFromToken(token);
    }
    ...
    public String issueAccessToken(akkimi_BE.aja.entity.User user) {
        return generateAccessToken(user.getSocialId());
    }

    public String issueRefreshToken(akkimi_BE.aja.entity.User user) {
        return generateRefreshToken(user.getSocialId());
    }
